...
| --- | --- | --- | --- | --- |
| `third_party/Audio-Maestro` | `https://github.com/gary920209/Audio-Maestro.git` | `ba443a215573ff2d5b85e8efbec268343b40baa2` | Not discoverable locally | No `LICENSE`, `COPYING`, or `NOTICE` file found in the checked-out submodule. README scan did not reveal a license section. |
| `third_party/DeSTA2.5-Audio` | `https://github.com/kehanlu/DeSTA2.5-Audio.git` | `e9b28ffd97c559eb178096b853321a1bbe5d97cf` | Not discoverable locally | No `LICENSE`, `COPYING`, or `NOTICE` file found in the checked-out submodule. README scan did not reveal a license section. |
| `third_party/ToolRL` | `https://github.com/qiancheng0/ToolRL.git` | `8cee13ec0ca72f0461da372a93a6fd8140dbb840` | Apache License 2.0 | `third_party/ToolRL/LICENSE` contains Apache-2.0 text. |
...
Do not add a top-level `LICENSE` before public release. The clean repo contains original/extracted research code, submodules, and patch overlays that interact with upstream projects whose local license status is incomplete.

## Private/Public Recommendation

- Private repository: acceptable for current research and preservation use.
- Public repository: not ready until license status is resolved for Audio-Maestro and DeSTA2.5-Audio, and until patch overlay distribution is reviewed.

## Unresolved License Decisions

- Confirm upstream license terms for Audio-Maestro.
- Confirm upstream license terms for DeSTA2.5-Audio.
