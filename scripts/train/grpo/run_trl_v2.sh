...
#SBATCH --gres=gpu:4
#SBATCH --mem=200G
#SBATCH --job-name=grpo-trl-v2
#SBATCH --output=grpo_trl_v2_slurm_%j.log
...
export WANDB_PROJECT="${WANDB_PROJECT:-grpo-desta-audio-v2}"
...
# --- Parameters ---
NUM_GPUS=4
CONFIG="${1:-grpo/configs/optimized_v2.yaml}"
...
echo "=============================================="
echo "  GRPO TRL Training v2 — DeSTA2.5-Audio"
echo "=============================================="
...
echo "GRPO TRL v2 training finished with exit code $EXIT_CODE."
