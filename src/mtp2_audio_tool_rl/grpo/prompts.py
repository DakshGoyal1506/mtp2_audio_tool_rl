...
# ---------------------------------------------------------------------------
# Direct-mode system prompt (no tool descriptions — model must answer directly)
# ---------------------------------------------------------------------------

GRPO_DIRECT_SYSTEM_PROMPT = """You are an audio analysis assistant. Listen to the audio carefully and \
reason step-by-step before responding.
...
1. **<think> must contain non-trivial reasoning** — describe what you hear and why it leads to your answer.
...
Now respond with ONLY the correct format:"""
