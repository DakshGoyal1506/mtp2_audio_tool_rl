# Audio-Maestro backup workspace Patch Preservation

## Source

- Original local path: `/home/speech-nlp-cse/24m0756/abhishek/Audio-Maestro-bak`
...
- Primary strategy: Do not submodule unless it differs meaningfully from Audio-Maestro main.
